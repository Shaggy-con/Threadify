        ...
        if(title.length<5){
          ...
          try {
            const res = await axios.post(
                "http://localhost:3000/createcolab",
                {
                  user_id: authData.id,
                  title: title,
    ...
    return (
      <div className="flex flex-row justify-items-start flex-wrap">
        ...
        <div className="px-4 py-6 md:px-6 md:py-12 lg:py-16 lg:w-3/5 mx-auto flex-grow">
          <Button onClick={() => navigate(-1)} className=" my-6">
            {"< Go Back "}
          </Button>
            ...
            <header className="sticky top-0 z-10 bg-white border-b">
              <div className="px-4 py-2 md:px-6">
                <h1 className="text-2xl font-semibold">
                  Create a New Colaborative blog post
                </h1>
              </div>
            </header>
                  ...
                  <div id="NewBlog">
                    <div className="space-y-6">
                      <div>
                        ...
                        <input
                          ...
                          id="title"
                          placeholder="Title will not be able to change later"
                          required=""
                        />
                      </div>
                    </div>
                      ...
                      <div className="grow m-3">
                        ...
                        <input
                          ...
                          className="flex w-full rounded-md 
                                    ...
                                    font-normal tracking-tight border-0 box-shadow-none h-auto"
                          id="title"
                    ...
                    <div className="flex flex-wrap p-2 gap-2 place-items-center">
                      ...
                      {addingtag.length === 0
                        ...
                        : addingtag.map((tag) => {
                            return (
                              <span className="inline-block font-bold rounded-lg bg-gray-100 px-2 py-1 text-m dark:bg-gray-800">
                                {tag.tagname}
                              </span>
                            );
                          })}
